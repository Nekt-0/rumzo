...
RUMZO v0.2 is a read-only research tool with local and hosted interfaces. It does not hold wallet keys, sign messages, submit transactions, install repository dependencies or run inspected code. It does not provide a contract audit.
